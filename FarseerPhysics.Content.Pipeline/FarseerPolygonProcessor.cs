...
namespace FarseerPhysics.ContentPipeline
{
  ...
  public class FarseerPolygonProcessor : ContentProcessor<PolygonContainer, PolygonContainer>
  {
    ...
    private PolygonContainer _paths;
    ...
    public override PolygonContainer Import(string filename, ContentImporterContext context)
    {
      if (ScaleFactor < 1)
      {
      ...
      _transformations.Push(Matrix.CreateScale(_scaleFactor, _scaleFactor, 1f));

      _paths = new PolygonContainer();
